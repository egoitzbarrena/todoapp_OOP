...
--
-- Servidor: localhost
-- Tiempo de generación: 23-09-2015 a las 18:10:41
...
INSERT INTO `listas` (`id_lista`, `titulo`, `archivada`) VALUES
(1, 'estudiar', 0),
(2, 'trabajar', 0);
...
INSERT INTO `tareas` (`id_tarea`, `descripcion`, `id_lista`, `archivada`) VALUES
(1, 'eeeooo', 1, 0),
(2, 'uuuuuuuuuuuuuui', 1, 0),
(3, 'ooiioii', 2, 0),
(4, 'wwwee', 2, 0);
